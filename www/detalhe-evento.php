...
<body>
	...
	<div class="container">
		<form action="process/participar-evento-process.php?participar=<?php echo $idEvento?>" method="post">
			<div class="form-row mb-3">
					<div class="form-group col-md-1">
						<label class="register-label">ID</label>
						<input type="text" name="id-evento" class="form-control" placeholder="Nome Completo" disabled required value="<?php echo $rowEvento['idevento'] ?>">
					</div>
					<div class="form-group col-md-9">
						<label class="register-label">Nome do Evento</label>
						<input type="text" name="nome-evento" class="form-control" placeholder="Nome do Evento" disabled required value="<?php echo $rowEvento['nome_evento'] ?>">
					</div>
					<div class="form-group col-md-2">
						<label class="register-label">Status do Evento</label>
						<input type="text" name="status-evento" class="form-control" required disabled value="<?php echo $rowEvento['aprovado'] ?>">
					</div>
			...
			<div class="form-row mb-3">
				<div class="form-group col-md-12">
					...
					<input name="empresa-org" disabled type="text" class="form-control" placeholder="Empresa Organizadora" value="<?php echo $rowEvento['empresa'] ?>">
				</div>
			</div>
			<div class="form-row mb-3">
				<div class="form-group col-md-2">
					<label class="register-label">Capacidade Máxima</label>				
					<input name="capacidade" type="number" class="form-control"placeholder="Capacidade Máxima" disabled value="<?php echo $rowEvento['capacidade'] ?>">
				</div>
				<div class="form-group col-md-6">				
					<label class="register-label">Local do Evento</label>
					<input name="local" type="text" class="form-control" placeholder="Local do Evento" disabled value="<?php echo $rowEvento['local'] ?>">
				</div>
				<div class="form-group col-md-2">				
					<label class="register-label">Data</label>
					<input name="data-evento" type="date" class="form-control" placeholder="Data do Evento" disabled value="<?php echo $rowConvertedDate[''] ?>">
				</div>
				<div class="form-group col-md-2">				
					<label class="register-label">Horário</label>
					<input name="hora-evento" disabled type="time" class="form-control" value="<?php echo $rowConvertedTime[''] ?>">
				</div>				
			</div>
			<div class="center">
